...
exports.currencies = {
  "USD": { "minfd": 8, "maxfd": 8, "name": "United States Dollar" },
  "EUR": { "minfd": 8, "maxfd": 8, "name": "Euro" },
  "CNY": { "minfd": 7, "maxfd": 7, "name": "Chinese Yuan" },
  "INR": { "minfd": 6, "maxfd": 6, "name": "Indian Rupees" },
  "JPY": { "minfd": 5, "maxfd": 5, "name": "Japanese Yen" },
  "GBP": { "minfd": 8, "maxfd": 8, "name": "British Pound Sterling" },
  "RUB": { "minfd": 6, "maxfd": 6, "name": "Russian Ruble" },
  "BRL": { "minfd": 7, "maxfd": 7, "name": "Brazilian Real" },
  "BUTK": { "minfd": 2, "maxfd": 2, "name": "Butkoin" },
  "USDT": { "minfd": 8, "maxfd": 8, "name": "Tether" },
  "BTC": { "minfd": 8, "maxfd": 8, "name": "Bitcoin" },
  "LTC": { "minfd": 7, "maxfd": 7, "name": "Litecoin" },
  "DOGE": { "minfd": 6, "maxfd": 6, "name": "Dogecoin" },
  "EXTO": { "minfd": 7, "maxfd": 7, "name": "Exto" }
},
