...
exports.home_url = "https://butkoin.com"
...
exports.cache = {
  ...
  "prices":           { "ttl": 30,    "size": 100 },
  "ticker":           { "ttl": 120,   "size": 100 },
  "addresses":        { "ttl": 120,   "size": 100 },
  "addresstxes":      { "ttl": 120,   "size": 100 },
  "txs":              { "ttl": 120,   "size": 100 },
  "balances":         { "ttl": 30,    "size": 100 },
  "distribution":     { "ttl": 60,    "size": 100 },
...
exports.shared_pages = {
  ...
  "links": [
    {
      "enabled": false,
      "tooltip_text": "Github Butkoin by Miningplanet",
      "url": "https://www.github.com/miningplanet",
      "text": "Github Butkoin",
      "icon": "github",
      "image_path": ""
    }],
...
exports.info_page = {
  ...
  "info": {
    "description": "Butkoin - Nr. Shitcoin description here. Ask ChatGPT4+",
    "home_url": "https://butkoin.com",
    "whitepaper_url": "https://butkoin.com/whitepaper.pdf",
    "whitepaper_title": "Butkoin Whitepaper",
    "show_coinbase": true,
...
exports.markets_page = {
  ...
  "exchanges": {
    ...
    "exbitron": {
      "enabled": true,
      "trading_pairs": [ "BUTK/USDT", "GALE/BUTK" ]
    },
    "btrmex": {
      "enabled": false,
...
exports.blockchain_specific = {
  ...
  "zksnarks": {
    ...
    //          If set to false, zk-SNARKs private txs will not be properly read or saved by but-x
...
exports.isYerbas = function isYerbas(net) {
  return net == 'yerbas'
}
