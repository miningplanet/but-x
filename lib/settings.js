...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    exceptions = ['get', 'getAllNet', 'getDefaultNet', 'getNet', 'getNetOrNull', 'getCoin', 'isButkoin', 'getDbConnectionString', 'getDbOrNull', 'getTitleLogo', 'panelOffset', 'panel', 'panels', 'loadSettings', 'formatCurrency'];
