...
exports.shared_pages = {
  ...
  "page_header": {
    ...
    // panels: default settings for panels displayed on page header (NOTE: you can show/hide the entire group of panels on each page independently).
    // Shows max. 5 panels (others hidden) in the sequence they are configured here (enabled=true)
    "panels": {
      "network_panel": {
        "enabled": false,
...
exports.getDbOrNull = function getDbOrNull(net=this.dbs[i].id) {
  var r = this.dbs[0]
...
exports.getTitleLogo = function getTitleLogo(net=this.dbs[i].id) {
  var r = this.wallets[0].id
  this.wallets.forEach(function(wallet) {
    if (wallet.id == net) {
      r = wallet.logo_title
...
exports.panelOffset = function panelOffset(net=this.dbs[i].id) {
...
exports.panel = function panel(index, net=this.dbs[i].id) {
  const panels = exports.panels(net)
  var r = []
  var i = 0
...
exports.panels = function panels(net=this.dbs[i].id) {
  var r
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    exceptions = ['get', 'getAllNet', 'getDefaultNet', 'getNet', 'getNetOrNull', 'getCoin', 'isButkoin', 'getDbs', 'getDbOrNull', 'getTitleLogo', 'panelOffset', 'panel', 'panels', 'loadSettings', 'formatCurrency'];
