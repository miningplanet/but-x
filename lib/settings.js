...
exports.panelOffset = function panelOffset(net='mainnet') {
...
exports.panel = function panel(index, net='mainnet') {
  const panels = exports.panels(net)
  var r = []
  var i = 0
...
exports.panels = function panels(net='mainnet') {
  var r
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    exceptions = ['get', 'getAllNet', 'getNet', 'getNetOrNull', 'getCoin', 'isButkoin', 'getDbs', 'getDbOrNull', 'getTitleLogo', 'panelOffset', 'panel', 'panels', 'loadSettings', 'formatCurrency'];
