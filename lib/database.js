...
module.exports = {
  ...
  get_tx_by_type: function(type, start, end, cb, net=settings.getDefaultNet()) {
  ...
  initialize_data_startup: function(cb, net=settings.getDefaultNet()) {
    ...
    module.exports.check_stats(coin.name, function(stats_exists) {
      ...
      module.exports.create_stats(coin.name, skip, function() {
        ...
        module.exports.get_stats(coin.name, function(stats) {
          console.log('+ %s DB initialization complete. Block height', net, stats.count)
          return cb()
        }, net)
      }, net)
    }, net)
  ...
  create_or_update_token: function(name, height, txid, vout, type, token, cb, net=settings.getDefaultNet()) {
