          ...
          lib.get_difficulty(net, function(difficulties) {
            ...
            if (dto) {
              ...
              if (isBut) {
                ...
                rr.difficulty_ghostrider = difficulties.pow_difficulties[0].diff,
                rr.difficulty_yespower = difficulties.pow_difficulties[1].diff,
                rr.difficulty_lyra2 = difficulties.pow_difficulties[2].diff,
                rr.difficulty_sha256d = difficulties.pow_difficulties[3].diff,
                rr.difficulty_scrypt = difficulties.pow_difficulties[4].diff,
                rr.difficulty_butkscrypt = difficulties.pow_difficulties[5].diff,
                ...
                rr.difficulty_pos = difficultyPOS,
                rr.difficulty = difficulties.pow_difficulties[0].diff,
                rr.difficulty_ghostrider = difficulties.pow_difficulties[0].diff
              }
