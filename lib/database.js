...
module.exports = {
  ...
  get_markets_summary: function(cb) {
    Markets.find({}, { _id: 0, market: 1, coin_symbol: 1, pair_symbol: 1, summary: 1 }, function(err, data) {
      if (data)
        return cb(data);
      else
        return cb(null);
  ...
  get_markets: function(cb) {
    Markets.find({}, { _id: 0, market: 1, coin_symbol: 1, pair_symbol: 1, summary: 1, chartdata: 1, buys: 1, sells: 1, history: 1 }, function(err, data) {
      if (data)
        return cb(data);
      else
        return cb(null);
