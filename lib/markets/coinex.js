...
var base_url = 'https://api.coinex.com/v1/';
...
function get_trades(coin, exchange, cb) {
  var req_url = base_url + 'market/deals?market=' + coin.toLowerCase() + exchange.toLowerCase() + '&last_id=0&limit=50';
...
function get_orders(coin, exchange, cb) {
  ...
  var req_url = base_url + 'market/depth?market=' + coin.toLowerCase() + exchange.toLowerCase() + '&merge=0&limit=50';
...
function get_chartdata(coin, exchange, cb) {
  ...
  var req_url = base_url + 'market/kline?market=' + coin.toUpperCase() + exchange.toUpperCase() + '&limit=250&type=5min'
